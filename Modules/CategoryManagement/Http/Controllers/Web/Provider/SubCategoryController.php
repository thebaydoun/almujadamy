...
class SubCategoryController extends Controller
{
    ...
    public function create(Request $request): Renderable
    {
        ...
        return view('categorymanagement::provider.sub-category.create', compact('subCategories', 'mainCategories', 'status', 'search'));
    }
    ...
    public function edit(string $id): View|Factory|RedirectResponse|Application
    {
        ...
        if (isset($subCategory)) {
            $mainCategories = $this->category->ofType('main')->orderBy('name')->get(['id', 'name']);
            return view('categorymanagement::provider.sub-category.edit', compact('subCategory', 'mainCategories'));
        }
