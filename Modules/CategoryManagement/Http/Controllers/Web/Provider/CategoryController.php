...
namespace Modules\CategoryManagement\Http\Controllers\Web\Provider;
...
class CategoryController extends Controller
{
    ...
    public function create(Request $request): View|Factory|Application
    {
        ...
        return view('categorymanagement::provider.create', compact('categories', 'zones', 'search', 'status'));
    }
    ...
    public function edit(string $id): View|Factory|Application|RedirectResponse
    {
        ...
        if (isset($category)) {
            $zones = $this->zone->where('is_active', 1)->withoutGlobalScope('translate')->get();
            return view('categorymanagement::provider.edit', compact('category', 'zones'));
        }
    ...
    public function ajaxChildesOnly(Request $request, $id): JsonResponse
    {
        ...
        return response()->json([
            'template' => view('categorymanagement::provider.partials._childes-selector', compact('categories', 'subCategoryId'))->render()
        ], 200);
    }
