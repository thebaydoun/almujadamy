...
class ProviderDriverController extends Controller
{
    ...
    public function create(Request $request): Application|Factory|View
    {
        ...
        return view('drivermodule::provider.create', compact('roles', 'zones'));
    }
    ...
    public function index(Request $request): Application|Factory|View
    {
        ...
        return view('drivermodule::provider.list', compact('employees', 'status', 'search'));
    }
    ...
    public function edit(string $id): Application|Factory|View
    {
        ...
        return view('drivermodule::provider.edit', compact('roles', 'zones', 'employee'));
    }
