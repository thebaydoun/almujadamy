                                ...
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    @if($file['type']=='folder')
                                        <a class="p-0 row text-capitalize"
                                           href="{{route('admin.business-settings.get-gallery-setup', base64_encode($file['path']))}}">
                                            <div><img class=""
                                        ...
                                        <div class="" data-bs-toggle="modal" data-bs-target="#imagemodal{{$key}}"
                                            ...
                                            <div class="gallary-card initial-25 mb-2">
                                                <img class="initial-26" width="150"
                                                     src="{{asset('storage/app/'.$file['path'])}}"
                                                     alt="{{$file['name']}}">
                                            </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a class="btn btn-primary"
                                                           href="{{route('admin.business-settings.download-gallery-image', base64_encode($file['path']))}}"><i
                                                                class="tio-download"></i> {{translate('download')}} </a>
