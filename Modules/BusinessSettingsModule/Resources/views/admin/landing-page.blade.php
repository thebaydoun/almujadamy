                                                        ...
                                                        <div class="mb-30 d-flex flex-column align-items-center gap-2">
                                                            <div class="upload-file mb-30 max-w-100">
                                                                <input type="file" class="upload-file__input"
                                                                       name="image" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div
                                                            ...
                                                            <div class="upload-file mb-30 max-w-100">
                                                                <input type="file" class="upload-file__input"
                                                                       name="image_1" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                                <div class="upload-file__img">
                                                                    <img
                                                                        src='{{asset('public/assets/admin-module/img/media/upload-file.png')}}'
                                                                        alt="">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div
                                                            ...
                                                            <div class="upload-file mb-30 max-w-100">
                                                                <input type="file" class="upload-file__input"
                                                                       name="image_2" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                                <div class="upload-file__img">
                                                                    <img
                                                                        src='{{asset('public/assets/admin-module/img/media/upload-file.png')}}'
                                                                        alt="">
                                                        ...
                                                        <form
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="upload-file max-w-100">
                                                                    <input type="file" class="upload-file__input"
                                                                           name="{{$key}}" id="image-{{$key}}" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                                    <div class="upload-file__img">
                                                                        <img
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-30 d-flex flex-column align-items-center gap-2">
                                                            <div class="upload-file mb-30 max-w-100">
                                                                <input type="file" class="upload-file__input"
                                                                       name="meta_image" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                                <div class="upload-file__img">
