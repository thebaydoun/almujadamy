                            ...
                            <div class="row g-3">
                                <div class="col-lg-4 col-md-6">
                                    <div class="statistics-card statistics-card__primary border flex-grow-1 d-flex gap-2 justify-content-between h-100 align-items-center">
                                        <div>
                                            <h2>{{with_currency_symbol($adminAccount->received_balance??0)}}</h2>
                                            <h3>{{translate('Admin_Balance')}}</h3>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="statistics-card statistics-card__total-orders border flex-grow-1 d-flex gap-2 justify-content-between h-100 align-items-center">
                                        <div>
                                            <h2>{{with_currency_symbol($adminAccount->received_balance??0)}}</h2>
                                            <h3>{{translate('Commission_Earning')}}</h3>
                                        </div>
                                        <div class="absolute-img position-static align-self-start"  data-bs-toggle="tooltip" data-bs-title="{{translate('Commission Earnings means the admin Earning from every booking')}}">
                                            <img src="{{asset('public/assets/admin-module')}}/img/icons/info.svg" class="svg" alt="">
                                        </div>
                                    </div>
                                </div>
