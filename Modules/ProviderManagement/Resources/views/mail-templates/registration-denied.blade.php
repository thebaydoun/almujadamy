...
<head>
    ...
    <title>{{translate('Registration Denied')}}</title>
...
<div class="box">
    <div class="top-wrap-box">
        ...
        <img src="{{asset('storage/app/public/business').'/' . $logo->live_values}}" alt="{{translate('Logo')}}" width="140"/>

        <h3 style="margin-top: 20px">{{translate('Registration Denied')}} !</h3>
        <h5>{{translate('Hi')}} {{$provider?->company_name}},</h5>
        <p>{{translate('Your registration request has been denied by admin.')}}.</p>
        <p>{{translate('Sorry, you can not login to provider panel / app')}}</p>
