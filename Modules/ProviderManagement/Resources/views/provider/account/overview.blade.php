                                ...
                                <div
                                    ...
                                    <div class="">
                                        ...
                                        <p class="d-flex align-items-center gap-2 text-muted">{{translate('Payable Balance')}}
                                            <i class="material-icons text-muted" data-bs-toggle="tooltip" title="{{translate('You have to pay this amount to the Admin.  As after adjusting the both  receivable and cash in hand balance, you have more cash in hand balance than receivable balance')}}">info</i>
                                        </p>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="">
                                        ...
                                        <p class="d-flex align-items-center gap-2 text-muted">{{translate('Withdraw-able Balance')}}
                                            <i class="material-icons text-muted" data-bs-toggle="tooltip"
                                               title="{{translate('You can withdraw this amount from the Admin. As after adjusting the both  receivable and cash in hand balance, you have more receivable balance than cash in hand.')}}">info</i></p>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div
                                    ...
                                    <div class="">
                                        ...
                                        <p class="d-flex align-items-center gap-2 text-muted">{{translate('Withdraw-able Balance')}}
                                            <i class="material-icons text-muted" data-bs-toggle="tooltip"
                                               title="{{translate(' You can withdraw this amount from Admin, as you have more receivable balance than cash in hand.')}}">info</i></p>
                                    </div>
                                    <button class="btn btn--warning" data-bs-toggle="modal" {{$collectable_cash < 1 ? 'disabled' : ''}}
                                ...
                                <div
                                    ...
                                    <div class="">
                                        ...
                                        <p class="d-flex align-items-center gap-2 text-muted">{{translate('withdraw_or_payable Balance')}}
                                            <i class="material-icons text-muted" data-bs-toggle="tooltip"
                                               title="{{translate('As both receivable and cash in hand balance is equal, So you can adjust this balance')}}">info</i></p>
                                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="bg-white information-details-box media flex-column flex-sm-row gap-20 h-100">
                        <img class="avatar-img radius-5 max-w220" src="{{onErrorImage(
                            $provider->logo,
                                ...
                                <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                                    @if(isset($provider->owner->identification_image) && count($provider->owner->identification_image) > 0)
                                        @foreach($provider->owner->identification_image as $key=>$image)
                                            <div>
                                                <img class="max-w320" src="{{onErrorImage(
                                                        $image,
                    ...
                    <div class="modal-body p-30">
                        ...
                        <ul class="radio-list justify-content-center mt-4">
                            @forelse($withdrawRequestAmount['random'] as $key=>$item)
                                <li>
                                    <input class="withdraw-dynamic-class" type="radio" id="withdraw_amount{{$key+1}}" name="withdraw_amount"
                                           data-withdraw-symbol="{{$item}}" hidden>
                                    <label for="withdraw_amount{{$key+1}}">{{with_currency_symbol($item)}}</label>
                                </li>
                            @empty
                                <li>
                                    <input class="withdraw-class" type="radio" id="withdraw_amount" name="withdraw_amount"
                                           data-withdraw="500" hidden>
                                    <label for="withdraw_amount">{{translate('500')}} {{currency_symbol()}}</label>
                                </li>
                                <li>
                                    <input type="radio" class="withdraw-class" id="withdraw_amount2" name="withdraw_amount"
                                           data-withdraw="1000" hidden>
                                    <label for="withdraw_amount2">1000 {{currency_symbol()}}</label>
                                </li>
                                <li>
                                    <input type="radio" class="withdraw-class" id="withdraw_amount3" name="withdraw_amount"
                                           data-withdraw="2000" hidden>
                                    <label for="withdraw_amount3">2000 {{currency_symbol()}}</label>
                                </li>
                                <li>
                                    <input type="radio" class="withdraw-class" id="withdraw_amount4" name="withdraw_amount"
                                           data-withdraw="5000" hidden>
                                    <label for="withdraw_amount4">5000 {{currency_symbol()}}</label>
                                </li>
                                <li>
                                    <input type="radio" class="withdraw-class" id="withdraw_amount5" name="withdraw_amount"
