                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-30">
                                            ...
                                            <input
                                                ...
                                                type="tel" class="form-control" name="company_phone" id="company_phone"
                                        ...
                                        <div class="form-floating mb-30">
                                            <select class="select-zone theme-input-style w-100" name="zone_id" required>
                                                ...
                                                @foreach($zones as $zone)
                                                    <option
                                                        value="{{$zone->id}}" {{ $provider->zone->id == $zone->id ? 'selected' : '' }}>{{$zone->name}}</option>
                                                @endforeach
                                            </select>
                                            <small
                                                class="d-block mt-1 text-danger">* {{translate('Update your latitude & longitude according to the selected zone')}}</small>
                                        </div>
                                        <div class="form-floating mb-30">
                                                ...
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img
                                                            ...
                                                            asset('public/assets/provider-module/img/media/upload-file.png') ,
                                                            'provider/logo/')}}"
                                                            alt="{{ translate('image') }}">
                                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-30">
                                            ...
                                            <input
                                                oninput="this.value = this.value.replace(/[^+\d]+$/g, '').replace(/(\..*)\./g, '$1');"
                                                type="tel" class="form-control" name="account_phone" id="account_phone"
                                                value="{{$provider->owner->phone}}"
                                                placeholder="{{translate('phone')}}" data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                data-bs-custom-class="custom-tooltip"
                                                data-bs-title="{{translate('Not_editable')}}" disabled>
                                        </div>
                                        <div class="row gx-2">
                                            <div class="col-lg-6">
                                                <div class="form-floating form-floating__icon mb-30">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-30">
                                            ...
                                            <input
                                                oninput="this.value = this.value.replace(/[^+\d]+$/g, '').replace(/(\..*)\./g, '$1');"
                                                type="tel" class="form-control" name="contact_person_phone"
