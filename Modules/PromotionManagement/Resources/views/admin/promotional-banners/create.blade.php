                ...
                <div class="col-12">
                    ...
                    <div class="card mb-30">
                        <div class="card-body p-30">
                            <form action="{{route('admin.banner.store')}}" method="POST" enctype="multipart/form-data" onSubmit="return validate();">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6 mb-4 mb-lg-0">
                                        ...
                                        <div class="form-floating form-floating__icon mb-30 link_selector" id="link_selector">
                                        ...
                                        <div class="d-flex flex-column align-items-center gap-3">
                                            ...
                                            <div>
                                                <div class="upload-file">
                                                    <input type="file" class="upload-file__input" name="banner_image"  accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
