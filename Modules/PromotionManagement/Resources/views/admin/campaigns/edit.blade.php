                                ...
                                <div class="discount-type">
                                        ...
                                        <div class="col-lg-6 mb-30">
                                            <div class="form-floating form-floating__icon">
                                                <input type="text" class="form-control" name="campaign_name"
                                                       ...
                                                       required="" accept=".{{ implode(',.', array_column(IMAGEEXTENSION, 'key')) }}, |image/*">
                                                    ...
                                                    <div>
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="upload-file__img upload-file__img_banner">
                                                                <img
                                                                        src="{{onErrorImage($campaign->cover_image,
                                                                        asset('storage/app/public/campaign').'/' . $campaign->cover_image,
                                                    ...
                                                    <div>
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="upload-file__img">
                                                                <img
                                                                        src="{{onErrorImage($campaign->thumbnail,
                                                                        asset('storage/app/public/campaign').'/' . $campaign->thumbnail,
                                                                        asset('public/assets/admin-module/img/media/upload-file.png') ,
                                                                        'campaign/')}}"
                                                                        alt="{{ translate('campaign') }}">
                                                            </div>
                                    ...
                                    <div class="mb-30" id="category_selector"
                                        ...
                                        <select class="category-select theme-input-style w-100" name="category_ids[]"
                                                multiple="multiple"
                                                id="category_selector__select" {{($campaign->discount->discount_type=='category' || $campaign->discount->discount_type=='mixed')?'required':''}}>
                                            ...
                                            <div class="mb-30">
                                                <div class="form-floating form-floating__icon">
                                                    <input type="number" class="form-control" name="discount_amount"
                                                           ...
                                                           min="0.01" {{$campaign->discount->discount_amount_type == 'percent'? 'max=100' : ''}}>
                                                    <label id="discount_amount__label">{{translate('amount')}}
                                                        ({{$campaign->discount->discount_amount_type == 'amount' ? currency_symbol() : '%'}}
                                                        )</label>
...
@push('script')
    <script>
        ...
        $('#category').on('click', function () {
            $('#service_selector__select').val(null).trigger('change');
        ...
        $('#service').on('click', function () {
            $('#category_selector__select').val(null).trigger('change');
