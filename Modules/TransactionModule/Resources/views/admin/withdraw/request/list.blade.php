                                            ...
                                            <table id="example" class="table align-middle multi-select-table">
                                                ...
                                                @foreach($withdrawRequests as $key=>$withdrawRequest)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="max-w320 min-w120 text-two-line" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2 justify-content-center">
                                                                @if($withdrawRequest->request_status=='pending')
                                                                    <button type="button" class="action-btn btn--danger" style="--size: 30px"
                                                                    ...
                                                                    <button type="button" class="action-btn btn--success" style="--size: 30px"
                                                                            data-bs-toggle="modal"
