                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        @if(!$withdrawalMethod->is_default)
                                                            <button type="button"
                                                                    class="action-btn btn--danger demo_check form-alert" style="--size: 30px"
                                                            ...
                                                            <form action="{{route('admin.withdraw.method.delete',[$withdrawalMethod->id])}}"
                                                                  method="post" id="delete-{{$withdrawalMethod->id}}" class="hidden">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        @endif
