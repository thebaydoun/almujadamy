                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.customer.loyalty-point.report', ['transaction_type'=>$queryParams['transaction_type']])}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 mb-30">
                                        <select class="js-select zone__select" name="zone_ids[]" multiple id="zone_selector__select" required>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-30">
                                        <select class="js-select customer__select" name="customer_ids[]" id="customer_selector__select" multiple>
                                            <option value="all">{{translate('Select All')}}</option>
                                            @foreach($customers as $customer)
                                                <option value="{{$customer['id']}}" {{array_key_exists('customer_ids', $queryParams) && in_array($customer['id'], $queryParams['customer_ids']) ? 'selected' : '' }}>{{$customer['first_name']. ' ' .$customer['last_name']}} ({{$customer['phone']}})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 mb-30">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column flex-sm-row flex-wrap gap-3 mb-4">
                                <div class="statistics-card statistics-card__total-orders border flex-grow-1">
                                    ...
                                    <div class="absolute-img"  data-bs-toggle="tooltip" data-bs-title="{{translate('Total spent points')}}">
                                ...
                                <div class="statistics-card statistics-card__ongoing border flex-grow-1">
                                    ...
                                    <div class="absolute-img"  data-bs-toggle="tooltip" data-bs-title="{{translate('Total earned points')}}">
                                        <img src="{{asset('public/assets/admin-module')}}/img/icons/info.svg" class="svg" alt="">
                                    </div>
                                </div>
                                ...
                                <div class="statistics-card statistics-card__subscribed-providers border flex-grow-1">
                                    ...
                                    <div class="absolute-img"  data-bs-toggle="tooltip" data-bs-title="{{translate('Available points')}}">
                                        <img src="{{asset('public/assets/admin-module')}}/img/icons/info.svg" class="svg" alt="">
                                    </div>
                                </div>
                            </div>
