                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="card card-body px-0 h-100">
                        ...
                        <div class="inbox_people">
                            <div class="d-flex gap-3 align-items-center mx-3">
                                <form action="#" class="search-form flex-grow-1">
                                    ...
                                    <div class="chat_list chat-list-class {{$chat->is_read==0?'active':''}}"
                                        ...
                                        <div class="chat_people media gap-10" id="chat_people">
                                            ...
                                            <div class="chat_ib media-body">
                                                <h5 class="">{{isset($fromUser->user) ? ($fromUser->user->provider ? $fromUser->user->provider->company_name : $fromUser->user->first_name) : translate('no_user_found')}}</h5>
                                                <span
