...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Demandium Software Installation"
            ...
            <div class="progress-bar width-p-20"></div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            <div class="d-flex justify-content-end mb-2">
                <a href="https://docs.6amtech.com/docs-demandium/intro" class="d-flex align-items-center gap-1"
                   target="_blank">
            ...
            <div class="text-center">
                ...
                @if ($permission['curl_enabled'] == 1 && $permission['db_file_write_perm'] == 1 && $permission['routes_file_write_perm'] == 1 && $phpVersion >= 8.0)
                    <a href="{{ route('step2',['token'=>bcrypt('step_2')]) }}" class="btn btn-dark px-sm-5">
                        {{translate('Proceed Next')}}</a>
                @endif
            </div>
        </div>
    </div>
